...
def fconv(
    ...
    fft: Any = scipy.fftpack.fft,
    ifft: Any = scipy.fftpack.ifft,
    boundary: Any = None,
    ...
    fft: Function handles to a routine that calls fft.
        By default, this code uses scipy.fftpack, however it will also accept
        the pyfftw `builders` objects.
    ifft: Function handles to a routine that calls ifft.
        By default, this code uses scipy.fftpack, however it will also accept
        the pyfftw `builders` objects.
